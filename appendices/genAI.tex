...
The proponents utilised three generative AI: ChatGPT, Deepseek, NotbeookLM. However, there are no set rules on which to use for specific topics. The proponents use either of the three depending on their convenience.
